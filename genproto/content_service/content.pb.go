...
var file_content_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0x78, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41,
	0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a,
	...
	0x49, 0x64, 0x22, 0xcc, 0x01, 0x0a, 0x07, 0x4a, 0x6f, 0x75, 0x72, 0x6e, 0x61, 0x6c, 0x12, 0x0e,
	...
	0x72, 0x22, 0xed, 0x01, 0x0a, 0x07, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x2b, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x08, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65,
	0x73, 0x22, 0xc5, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x75, 0x72,
	...
	0x09, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x22, 0xc7, 0x01, 0x0a, 0x10, 0x43, 0x72,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x8a, 0x06, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
...
var file_content_proto_goTypes = []interface{}{
	(*File)(nil),              // 0: content_service.File
	(*PrimaryKey)(nil),        // 1: content_service.PrimaryKey
	(*PrimaryKeyList)(nil),    // 2: content_service.PrimaryKeyList
	(*GetList)(nil),           // 3: content_service.GetList
	(*GetArticleListReq)(nil), // 4: content_service.GetArticleListReq
	(*Journal)(nil),           // 5: content_service.Journal
	(*Article)(nil),           // 6: content_service.Article
	(*CreateJournalReq)(nil),  // 7: content_service.CreateJournalReq
	(*CreateArticleReq)(nil),  // 8: content_service.CreateArticleReq
	(*GetJournalListRes)(nil), // 9: content_service.GetJournalListRes
	(*GetArticleListRes)(nil), // 10: content_service.GetArticleListRes
	(*emptypb.Empty)(nil),     // 11: google.protobuf.Empty
}
var file_content_proto_depIdxs = []int32{
	0,  // 0: content_service.Article.files:type_name -> content_service.File
	0,  // 1: content_service.CreateArticleReq.files:type_name -> content_service.File
	5,  // 2: content_service.GetJournalListRes.journals:type_name -> content_service.Journal
	6,  // 3: content_service.GetArticleListRes.articles:type_name -> content_service.Article
	7,  // 4: content_service.ContentService.CreateJournal:input_type -> content_service.CreateJournalReq
	1,  // 5: content_service.ContentService.GetJournal:input_type -> content_service.PrimaryKey
	3,  // 6: content_service.ContentService.GetJournalList:input_type -> content_service.GetList
	5,  // 7: content_service.ContentService.UpdateJournal:input_type -> content_service.Journal
	1,  // 8: content_service.ContentService.DeleteJournal:input_type -> content_service.PrimaryKey
	8,  // 9: content_service.ContentService.CreateArticle:input_type -> content_service.CreateArticleReq
	1,  // 10: content_service.ContentService.GetArticle:input_type -> content_service.PrimaryKey
	4,  // 11: content_service.ContentService.GetArticleList:input_type -> content_service.GetArticleListReq
	6,  // 12: content_service.ContentService.UpdateArticle:input_type -> content_service.Article
	1,  // 13: content_service.ContentService.DeleteArticle:input_type -> content_service.PrimaryKey
	5,  // 14: content_service.ContentService.CreateJournal:output_type -> content_service.Journal
	5,  // 15: content_service.ContentService.GetJournal:output_type -> content_service.Journal
	9,  // 16: content_service.ContentService.GetJournalList:output_type -> content_service.GetJournalListRes
	5,  // 17: content_service.ContentService.UpdateJournal:output_type -> content_service.Journal
	11, // 18: content_service.ContentService.DeleteJournal:output_type -> google.protobuf.Empty
	6,  // 19: content_service.ContentService.CreateArticle:output_type -> content_service.Article
	6,  // 20: content_service.ContentService.GetArticle:output_type -> content_service.Article
	10, // 21: content_service.ContentService.GetArticleList:output_type -> content_service.GetArticleListRes
	6,  // 22: content_service.ContentService.UpdateArticle:output_type -> content_service.Article
	11, // 23: content_service.ContentService.DeleteArticle:output_type -> google.protobuf.Empty
