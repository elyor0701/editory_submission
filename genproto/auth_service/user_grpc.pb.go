...
const (
	...
	UserService_GetUserListByRole_FullMethodName              = "/auth_service.UserService/GetUserListByRole"
	UserService_GenerateEmailVerificationToken_FullMethodName = "/auth_service.UserService/GenerateEmailVerificationToken"
	UserService_EmailVerification_FullMethodName              = "/auth_service.UserService/EmailVerification"
)
...
func (c *userServiceClient) GetUserListByRole(ctx context.Context, in *GetUserListByRoleReq, opts ...grpc.CallOption) (*GetUserListByRoleRes, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetUserListByRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GenerateEmailVerificationToken(ctx context.Context, in *GenerateEmailVerificationTokenReq, opts ...grpc.CallOption) (*GenerateEmailVerificationTokenRes, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GenerateEmailVerificationToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) EmailVerification(ctx context.Context, in *EmailVerificationReq, opts ...grpc.CallOption) (*EmailVerificationRes, error) {
	...
	err := c.cc.Invoke(ctx, UserService_EmailVerification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_GetUserListByRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetUserListByRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GenerateEmailVerificationToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GenerateEmailVerificationToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
