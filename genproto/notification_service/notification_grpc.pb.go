...
const (
	...
	NotificationService_GetNotificationList_FullMethodName = "/notification_service.NotificationService/GetNotificationList"
	...
	NotificationService_GenerateMailMessage_FullMethodName = "/notification_service.NotificationService/GenerateMailMessage"
)
...
func (c *notificationServiceClient) GetNotificationList(ctx context.Context, in *GetNotificationListReq, opts ...grpc.CallOption) (*GetNotificationListRes, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetNotificationList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) GenerateMailMessage(ctx context.Context, in *GenerateMailMessageReq, opts ...grpc.CallOption) (*GenerateMailMessageRes, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GenerateMailMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_GenerateMailMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GenerateMailMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
